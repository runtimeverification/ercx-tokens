...
abstract contract ERC20Standard is ERC20Abstract {
    ...
    ****************************/
    ...
    external initializeStateTwoUsers(balance1, balance2) {
        assertSuccess(_tryBobTransferFrom(alice, alice, 0), "Bob failed to transferFrom zero amount from Alice's account to Alice.");
    }
    ...
    external initializeStateTwoUsers(balance1, balance2) {
        assertSuccess(_tryBobTransferFrom(alice, carol, 0), "Bob failed to transferFrom zero amount from Alice's account to Carol.");
    }
    ...
    external initializeStateTwoUsers(balance1, balance2) {
        assertSuccess(_tryBobTransferFrom(alice, alice, 0), "Bob failed to transferFrom zero amount from Alice's account to herself.");
    }
    ...
    external initializeStateTwoUsers(balance1, balance2) {
        assertSuccess(_tryAliceTransferFrom(alice, carol, 0), "Alice failed to transferFrom zero amount from her account to Carol.");
    }
    ...
    ****************************/
    ...
    function testZeroApprovalEventEmission() 
    external {
        vm.expectEmit(true, true, true, true);
    ...
    /// @custom:ercx-concerned-function approve, Approval
    function testPositiveApprovalEventEmission(uint256 amount) 
    external {
        vm.assume(amount > 0);
        vm.expectEmit(true, true, true, true);
    ...
    /// @custom:ercx-concerned-function approve, transferFrom
    function testPositiveApproveAllowsPositiveTransferFrom(uint256 approveAmount, uint256 transferAmount, uint256 balance1, uint256 balance2) 
    external {
    ...
    function internalTestPositiveApproveAllowsTransferFrom(uint256 approveAmount, uint256 transferAmount, uint256 balance1, uint256 balance2) 
    internal initializeStateTwoUsers(balance1, balance2) {
        ...
        assertSuccess(_tryBobTransferFrom(alice, bob, transferAmount), "Bob failed to transferFrom from Alice to his account.");
    }
    ...
    ****************************/
    ...
    function _internalTestApproveLeadsToAllowance(uint256 amount) internal {
        ...
        conditionalSkip(!callApprove.success, "Inconclusive test: Alice failed to approve Bob.");
        assertEq(cut.allowance(alice, bob), amount, "The value of allowance(alice, bob) does not equate the value approved by Alice to Bob.");
    }
    ...
    ****************************/
    ...
    external initializeStateTwoUsers(balance1, balance2) {
        ...
        assertFail(_tryBobTransferFrom(alice, bob, amount), "Bob was able to transferFrom Alice while he was not approved.");
    }
    ...
    external initializeStateTwoUsers(balance1, balance2) {
        ...
        uint256 aliceBalance = cut.balanceOf(alice);
        vm.assume(aliceBalance >= amount);
        assertFail(_tryAliceTransferFrom(alice, bob, amount), "Alice was able to transferFrom self while she was not approved by herself.");
    }
    ...
    /// @custom:ercx-concerned-function transferFrom
    function testCannotTransferFromMoreThanAllowanceLowerThanBalance(uint256 approveAmount, uint256 transferAmount, uint256 balance1, uint256 balance2) 
    external initializeStateTwoUsers(balance1, balance2) {
        vm.assume(transferAmount > 0);
        vm.assume(approveAmount > 0);
        ...
        conditionalSkip(!callResultApprove.success, "Inconclusive test: Alice failed to approve Bob.");
        assertFail(_tryBobTransferFrom(alice, bob, transferAmount), "Bob was able to transferFrom Alice more than the allowance given by Alice.");
    }
    ...
    /// @custom:ercx-categories transferFrom, allowance, balance
    /// @custom:ercx-concerned-function transferFrom
    function testCannotTransferFromMoreThanBalanceButLowerThanAllowance(uint256 approveAmount, uint256 transferAmount, uint256 balance1, uint256 balance2) 
    external initializeStateTwoUsers(balance1, balance2) {
        vm.assume(transferAmount > cut.balanceOf(alice));
        vm.assume(transferAmount < approveAmount);
        CallResult memory callResultApprove = _tryAliceApprove(bob, approveAmount);
        conditionalSkip(!callResultApprove.success, "Inconclusive test: Alice failed to approve Bob.");
        assertFail(_tryBobTransferFrom(alice, carol, transferAmount), "Bob was able to transferFrom Alice more than Alice's balance.");
    }
