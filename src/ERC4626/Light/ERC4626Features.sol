...
abstract contract ERC4626Features is ERC4626Abstract {
    ...
    function testConvertToSharesZeroAmountIsPossible() public virtual {
    ...
    function testConvertToAssetsZeroAmountIsPossible() public virtual {
    ...
    function testPreviewDepositZeroAmountIsPossible() public virtual {
    ...
    function testDepositZeroAmountIsPossible() public virtual {
    ...
    function testPreviewMintZeroAmountIsPossible() public virtual {
    ...
    function testMintZeroAmountIsPossible() public virtual {
    ...
    function testPreviewWithdrawZeroAmountIsPossible() public virtual {
    ...
    function testWithdrawZeroAmountIsPossible() public virtual {
    ...
    function testPreviewRedeemZeroAmountIsPossible() public virtual {
    ...
    function testRedeemZeroAmountIsPossible() public virtual {
    ...
    /// @custom:ercx-concerned-function convertToAssets
    function testConvertToAssetsIntOverflowLimitFollowsSolmate() public virtual {
    ...
    /// @custom:ercx-categories assets, shares
    /// @custom:ercx-concerned-function convertToShares
    function testConvertToSharesIntOverflowLimitFollowsSolmate() public virtual {
        uint256 totalSupply = cut4626.totalSupply();
        if (totalSupply > 0) {
    ...
    function testMaxDepositReturnMaxUint256IfNoLimit() public virtual {
    ...
    function testMaxMintReturnMaxUint256IfNoLimit() public virtual {
    ...
    function testSharesIsTransferAble(uint256 aliceShares) public virtual initializeSharesTwoUsers(aliceShares, 0) {
        vm.assume(aliceShares > 0);
    ...
    function testTotalAssetsLtVaultAssetsBalance() public virtual {
        uint256 totalAssets = cut4626.totalAssets();
    ...
    /// @custom:ercx-categories assets, total assets
    /// @custom:ercx-concerned-function totalAssets
    function testTotalAssetsGtVaultAssetsBalance() public virtual {
        uint256 totalAssets = cut4626.totalAssets();
        uint256 balance = asset.balanceOf(address(cut4626));
    ...
    /// @custom:ercx-concerned-function totalAssets
    function testTotalAssetsGtZero() public virtual {
        uint256 totalAssets = cut4626.totalAssets();
    ...
    function testTotalSupplyGtZero() public virtual {
        uint256 totalSupply = cut4626.totalSupply();
    ...
    function testTotalAssetsLtTotalSupply() public virtual {
        uint256 totalAssets = cut4626.totalAssets();
        uint256 totalSupply = cut4626.totalSupply();
    ...
    /// @custom:ercx-categories total assets, total supply
    /// @custom:ercx-concerned-function totalAssets, totalSupply
    function testTotalAssetsGtTotalSupply() public virtual {
        uint256 totalAssets = cut4626.totalAssets();
        uint256 totalSupply = cut4626.totalSupply();
