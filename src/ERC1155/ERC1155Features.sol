...
abstract contract ERC1155Features is ERC1155Abstract {
    ...
    function testSafeTransferFromIncreaseEoaReceiverBalanceLtExpected(
        uint256 tokenId,
        ...
        _propertySafeTransferFromIncreaseReceiverBalance(
            false, ArithmeticOperator.Lesser, tokenId, aliceTokenBalance, bobTokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, balance
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromIncreaseEoaReceiverBalanceGtExpected(
        uint256 tokenId,
        uint256 aliceTokenBalance,
        uint256 bobTokenBalance,
        uint256 tokenAmount,
        ...
        _propertySafeTransferFromIncreaseReceiverBalance(
            false, ArithmeticOperator.Greater, tokenId, aliceTokenBalance, bobTokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, balance
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromToEoaDecreaseOwnerBalanceLtExpected(
        uint256 tokenId,
        ...
        _propertySafeTransferFromDecreaseOwnerBalance(
            false, ArithmeticOperator.Lesser, tokenId, tokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, balance
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromToEoaDecreaseOwnerBalanceGtExpected(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySafeTransferFromDecreaseOwnerBalance(
            false, ArithmeticOperator.Greater, tokenId, tokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromIncreaseContractReceiverBalanceLtExpected(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySafeTransferFromIncreaseReceiverBalance(
            true, ArithmeticOperator.Lesser, tokenId, tokenBalance, 0, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, contract receiver
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromIncreaseContractReceiverBalanceGtExpected(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySafeTransferFromIncreaseReceiverBalance(
            true, ArithmeticOperator.Greater, tokenId, tokenBalance, 0, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromToContractDecreaseOwnerBalanceLtExpected(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySafeTransferFromDecreaseOwnerBalance(
            true, ArithmeticOperator.Lesser, tokenId, tokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, balance, contract receiver
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSafeTransferFromToContractDecreaseOwnerBalanceGtExpected(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySafeTransferFromDecreaseOwnerBalance(
            true, ArithmeticOperator.Greater, tokenId, tokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, balance
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSelfSafeTransferFromSelfToSelfDecreasesOwnerBalance(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySelfSafeTransferFromSelfToSelfChangeOwnerBalance(
            ArithmeticOperator.Lesser, tokenId, tokenBalance, tokenAmount, data
        );
    }
    ...
    /// @custom:ercx-categories single transfer, balance
    /// @custom:ercx-concerned-function safeTransferFrom, setApprovalForAll
    function testSelfSafeTransferFromSelfToSelfIncreasesOwnerBalance(
        uint256 tokenId,
        uint256 tokenBalance,
        uint256 tokenAmount,
        bytes calldata data
        ...
        _propertySelfSafeTransferFromSelfToSelfChangeOwnerBalance(
            ArithmeticOperator.Greater, tokenId, tokenBalance, tokenAmount, data
        );
    }
}
