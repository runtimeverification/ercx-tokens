...
abstract contract ERC721Standard is ERC721Abstract {
    ...
    function testCanEnableSeveralOperators(address allowingAddress, address[3] calldata allowedOperators) external {
        ...
        for (uint8 i = 0; i < allowedOperators.length; i++) {
            for (uint256 j = 0; j < allowedOperators.length; j++) {
                if (j != i) {
    ...
    function testEventTransferEmitsWhenSafeTransferFromWithDataByOwnerToEOA(
        uint256 tokenId,
    ...
    /// @custom:ercx-categories event, safeTranferFrom
    /// @custom:ercx-concerned-function safeTranferFrom
    function testEventTransferEmitsWhenSafeTransferFromWithDataByApprovedAddressToEOA(
        uint256 tokenId,
        ...
        _propertyEventTransferEmitsWhenSafeTransferFromWithDataByApprovedAddress(
            tokenId, approvedAddress, tokenReceiver, data
        );
    }
    ...
    /// @custom:ercx-categories event, safeTranferFrom
    /// @custom:ercx-concerned-function safeTranferFrom
    function testEventTransferEmitsWhenSafeTransferFromWithDataByApprovedAddressToReceiver(
        uint256 tokenId,
        address approvedAddress,
        bytes memory data
    ...
    /// @custom:ercx-categories event, safeTranferFrom
    /// @custom:ercx-concerned-function safeTranferFrom
    function testEventTransferEmitsWhenSafeTransferFromWithDataByOperatorToEOA(
        uint256 tokenId,
        address operator,
        address tokenReceiver,
        bytes memory data
    ...
    /// @custom:ercx-categories event, safeTranferFrom
    /// @custom:ercx-concerned-function safeTranferFrom
    function testEventTransferEmitsWhenSafeTransferFromWithDataByOperatorToReceiver(
        uint256 tokenId,
        address operator,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    function testEventTransferEmitsWhenTransferFromWithoutDataByApprovedAddressToEOA(
        ...
        _propertyEventTransferEmitsWhenSafeTransferFromWithoutDataByApprovedAddress(
            tokenId, approvedAddress, tokenReceiver
        );
    }
    ...
    /// @custom:ercx-categories balance
    /// @custom:ercx-concerned-function balanceOf
    function testUserBalanceIncrementedAfterReceivingAnOwnedToken(uint256 tokenId) external withUsers {
    ...
    /// @custom:ercx-categories balance
    /// @custom:ercx-concerned-function balanceOf
    function testUserBalanceCorrectAfterReceivingSeveralTokens(uint256[3] calldata tokenIds) external withUsers {
        uint256 initiaAlicelBalance = cut.balanceOf(alice);
        _dealSeveralOwnedTokensToAlice(tokenIds);
        assertEq(
            cut.balanceOf(alice),
            initiaAlicelBalance + tokenIds.length,
    ...
    function testOwnerOfUpdated(uint256 tokenId) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    */
    ...
    function testRevertsByOwnerWhenOwnerIsNotFromInSafeTransferFromWithDataToEOA(
        address fromAddress,
        address toAddress,
        uint256 tokenId,
        bytes memory data
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testRevertsByOwnerWhenOwnerIsNotFromInSafeTransferFromWithDataToReceiver(
        address fromAddress,
        uint256 tokenId,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testRevertsBySomeoneWhenOwnerIsNotFromInSafeTransferFromWithDataToEOA(
        ...
        _propertyRevertsBySomeoneWhenOwnerIsNotFromInSafeTransferFromWithData(
            transferInitiator, fromAddress, toAddress, tokenId, data
        );
    }
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testRevertsBySomeoneWhenOwnerIsNotFromInSafeTransferFromWithDataToReceiver(
        address transferInitiator,
        address fromAddress,
        uint256 tokenId,
        bytes memory data
        ...
        _propertyRevertsBySomeoneWhenOwnerIsNotFromInSafeTransferFromWithData(
            transferInitiator, fromAddress, bob, tokenId, data
        );
    }
    ...
    function testRevertsSafeTransferFromWithDataToEOAWhenTokenIDIsNotValid(
        address transferInitiator,
        address fromAddress,
        address toAddress,
        uint256 tokenId,
        ...
        _propertyRevertsSafeTransferFromWithDataWhenTokenIDIsNotValid(
            transferInitiator, fromAddress, toAddress, tokenId, data
        );
    }
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom
    function testRevertsSafeTransferFromWithDataToReceiverWhenTokenIDIsNotValid(
        address transferInitiator,
        address fromAddress,
        uint256 tokenId,
        bytes memory data
    ...
    {
        assertFail(
            _tryAliceSafeTransferFromWithData(alice, address(0x0), tokenId, data),
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        assertFail(
            _tryBobSafeTransferFromWithData(alice, address(0x0), tokenId, data),
    ...
    /// @custom:ercx-categories transfer, zero address
    /// @custom:ercx-concerned-function safeTransferFrom
    function testRevertsWhenSomeoneSafeTransferFromWithDataToZeroAddress(
        uint256 tokenId,
        address transferInitiator,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
        ...
        assertFail(
            _tryCustomerSafeTransferFromWithData(transferInitiator, alice, address(0x0), tokenId, data),
            "A `safeTransferFrom(address,address,uint256,bytes)` could be initiated by the token owner to the zero address."
        );
    }
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom
    function testRevertsWhenSafeTransferFromWithDataToRecipientIsIncorrectReceiverByOwner(
        uint256 tokenId,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
        // eve is an incorrect receiver
        assertFail(
            _tryAliceSafeTransferFromWithData(alice, eve, tokenId, data),
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom
    function testRevertsWhenSafeTransferFromWithDataToRecipientIsIncorrectReceiverBySomeone(
        uint256 tokenId,
        address transferInitiator,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
        ...
        // eve is an incorrect receiver
        assertFail(
            _tryCustomerSafeTransferFromWithData(transferInitiator, alice, eve, tokenId, data),
            "A `safeTransferFrom(address,address,uint256,bytes)` could be initiated when recipient does not return bytes4(keccak256(...)) when calling onERC721Received."
        );
    }
    ...
    */
    ...
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataByOwnerToEOAUpdatesOwnership(
        address tokenReceiver,
        uint256 tokenId,
        bytes memory data
    ) external withUsers ensureNotATokenReceiver(tokenReceiver) dealAnOwnedTokenToAlice(tokenId) {
    ...
    /// @custom:ercx-categories transfer, ownership
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataByOwnerToEOAResetsApprovedAddress(
        address tokenReceiver,
        uint256 tokenId,
    ...
    /// @custom:ercx-categories transfer, ownership
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataByOwnerToReceiverResetsApprovedAddress(
        uint256 tokenId,
        address initialApprovee,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    */
    ...
    /// @custom:ercx-concerned-function safeTransferFrom, approve
    function testApprovedAddressCanSafeTransferFromWithDataToEOA(
        address tokenReceiver,
        uint256 tokenId,
        bytes memory data
    ) external withUsers ensureNotATokenReceiver(tokenReceiver) dealAnOwnedTokenToAlice(tokenId) {
    ...
    /// @custom:ercx-categories transfer approval
    /// @custom:ercx-concerned-function safeTransferFrom, approve
    function testApprovedAddressCanSafeTransferFromWithDataToEOAFromToSelf(
        address tokenReceiver,
        uint256 tokenId,
        bytes memory data
    ) external withUsers ensureNotATokenReceiver(tokenReceiver) dealAnOwnedTokenToAlice(tokenId) {
    ...
    function testSafeTransferFromWithDataByApprovedEOAAddressToSelfUpdatesOwnership(
        address tokenReceiver,
        uint256 tokenId,
        bytes memory data
    ) external withUsers ensureNotATokenReceiver(tokenReceiver) dealAnOwnedTokenToAlice(tokenId) {
    ...
    /// @custom:ercx-categories transfer, ownership, approval
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf, approve
    function testSafeTransferFromWithDataByApprovedReceiverAddressToSelfUpdatesOwnership(
        uint256 tokenId,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    /// @custom:ercx-categories transfer, ownership
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataByApprovedEOAAddressResetsApprovedAddress(
        address tokenReceiver,
        uint256 tokenId,
        address initialApprovee,
        bytes memory data
    ) external withUsers ensureNotATokenReceiver(tokenReceiver) dealAnOwnedTokenToAlice(tokenId) {
        _propertySafeTransferFromWithDataByApprovedAddressResetsApprovedAddress(
            tokenReceiver, tokenId, initialApprovee, data
        );
    }
    ...
    /// @custom:ercx-categories transfer, ownership
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataByApprovedReceiverAddressResetsApprovedAddress(
        uint256 tokenId,
        address initialApprovee,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    */
    ...
    {
        assertTrue(
            _AliceSetApprovedForAllBobAndBobSafeTransfersFromWithDataToSelf(tokenId, data),
    ...
    /// @custom:ercx-categories transfer, ownership, approval
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf, approve
    function testSafeTransferFromWithDataByOperatorToEOAUpdatesOwnership(
        address tokenReceiver,
        uint256 tokenId,
        bytes memory data
    ) external withUsers ensureNotATokenReceiver(tokenReceiver) dealAnOwnedTokenToAlice(tokenId) {
    ...
    /// @custom:ercx-categories transfer, ownership
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataToEOAByOperatorResetsApprovedAddress(
        address tokenReceiver,
        uint256 tokenId,
        address operator,
        bytes memory data
        ...
        if (
            _AliceSetApprovedForAllCustomerAndCustomerSafeTransfersFromWithDataToSomeone(
                tokenId, data, operator, tokenReceiver
            )
        ) {
            assertEq(
                cut.getApproved(tokenId),
    ...
    /// @custom:ercx-categories transfer, ownership
    /// @custom:ercx-concerned-function safeTransferFrom, ownerOf
    function testSafeTransferFromWithDataToReceiverByOperatorResetsApprovedAddress(
        uint256 tokenId,
        address operator,
        bytes memory data
    ) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    */
    ...
    function testRevertsBySomeoneWhenOwnerIsNotFromInSafeTransferFromToEOA(
        ...
        _propertyRevertsBySomeoneWhenOwnerIsNotFromInSafeTransferFrom(
            transferInitiator, fromAddress, toAddress, tokenId
        );
    }
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom
    function testRevertsSafeTransferFromToEOAWhenTokenIDIsNotValid(
        address transferInitiator,
        address fromAddress,
        address toAddress,
        uint256 tokenId
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function safeTransferFrom
    function testRevertsSafeTransferFromToReceiverWhenTokenIDIsNotValid(
        address transferInitiator,
        address fromAddress,
        uint256 tokenId
    ) external withUsers {
    ...
    {
        assertFail(
            _tryAliceSafeTransferFrom(alice, address(0x0), tokenId),
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        conditionalSkip(!callApprove.success, "Inconclusive test: could not approve some address.");
        assertFail(
            _tryBobSafeTransferFrom(alice, address(0x0), tokenId),
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        assertFail(
            _tryCustomerSafeTransferFrom(transferInitiator, alice, address(0x0), tokenId),
            "A `safeTransferFrom(address,address,uint256)` (without data) could be initiated by the token owner to the zero address."
        );
    }
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        // eve is an incorrect receiver
        assertFail(
            _tryAliceSafeTransferFrom(alice, eve, tokenId),
    ...
    function testRevertsWhenSafeTransferFromToRecipientIsIncorrectReceiverBySomeone(
        ...
        // eve is an incorrect receiver
        assertFail(
            _tryCustomerSafeTransferFrom(transferInitiator, alice, eve, tokenId),
            "A `safeTransferFrom(address,address,uint256)` (without data) could be initiated when recipient does not return bytes4(keccak256(...)) when calling onERC721Received."
        );
    }
    ...
    */
    ...
    {
        assertTrue(
            _AliceSetApprovedForAllBobAndBobSafeTransfersFromToSelf(tokenId),
            "A safeTransferFrom(address,address,uint256,bytes)` could not be initiated by the approved address to himself."
        );
    }
    ...
    */
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function transferFrom
    function testRevertsTransferFromToEOAWhenTokenIDIsNotValid(
        address transferInitiator,
        address fromAddress,
        address toAddress,
        uint256 tokenId
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function transferFrom
    function testRevertsTransferFromToReceiverWhenTokenIDIsNotValid(
        address transferInitiator,
        address fromAddress,
        uint256 tokenId
    ) external withUsers {
    ...
    {
        assertFail(
            _tryAliceTransferFrom(alice, address(0x0), tokenId),
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        conditionalSkip(!callApprove.success, "Inconclusive test: could not approve some address.");
        assertFail(
            _tryBobTransferFrom(alice, address(0x0), tokenId),
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        assertFail(
            _tryCustomerTransferFrom(transferInitiator, alice, address(0x0), tokenId),
            "A `transferFrom(address,address,uint256)` could be initiated by the token owner to the zero address."
        );
    }
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        // eve is an incorrect receiver
        assertFail(
            _tryAliceTransferFrom(alice, eve, tokenId),
    ...
    function testRevertsWhenTransferFromToRecipientIsIncorrectReceiverBySomeone(
        ...
        // eve is an incorrect receiver
        assertFail(
            _tryCustomerTransferFrom(transferInitiator, alice, eve, tokenId),
            "A `transferFrom(address,address,uint256)` could be initiated when recipient does not return bytes4(keccak256(...)) when calling onERC721Received."
        );
    }
    ...
    */
    ...
    /// @custom:ercx-categories transfer
    /// @custom:ercx-concerned-function transferFrom
    function testOwnerCanTransferFromToReceiver(uint256 tokenId) external withUsers dealAnOwnedTokenToAlice(tokenId) {
    ...
    */
    ...
    /// @custom:ercx-categories transfer approval
    /// @custom:ercx-concerned-function transferFrom, approve
    function testOperatorCanTransferFromToSelf(uint256 tokenId) external withUsers dealAnOwnedTokenToAlice(tokenId) {
        assertTrue(
            _AliceSetApprovedForAllBobAndBobSafeTransfersFromToSelf(tokenId),
    ...
    function testApprovesDefinesApprovedAddress(uint256 tokenId) external withUsers dealAnOwnedTokenToAlice(tokenId) {
        vm.assume(cut.getApproved(tokenId) == address(0x0));
        CallResult memory callApprove = _tryAliceApprove(bob, tokenId);
        if (callApprove.success) {
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        CallResult memory callApprove = _tryAliceApprove(bob, tokenId);
        conditionalSkip(
            !(callApprove.success && cut.getApproved(tokenId) == bob),
        ...
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        conditionalSkip(
            !(approvalCall.success && cut.getApproved(tokenId) == address(0x0)),
    ...
    /// @custom:ercx-categories approval,
    /// @custom:ercx-concerned-function approve
    function testApproveRevertsWhenMsgSenderIsNotOwner(uint256 tokenId, address tokenApprover, uint256 amountPaid)
        external
        withUsers
        dealAnOwnedTokenToAlice(tokenId)
    {
    ...
    /// @custom:ercx-categories approval
    /// @custom:ercx-concerned-function setApprovalForAll
    function testCanEnableSomeOneAsOperator(address tokenOperator, uint256 tokenId)
        external
        withUsers
        dealAnOwnedTokenToAlice(tokenId)
    {
    ...
    /// @custom:ercx-categories approval
    /// @custom:ercx-concerned-function setApprovalForAll
    function testCanEnableAndDisableSomeOneAsOperator(address tokenOperator, uint256 tokenId)
        external
        withUsers
        dealAnOwnedTokenToAlice(tokenId)
    {
        ...
        CallResult memory approvalCall = _tryAliceSetApprovalForAll(tokenOperator, true);
        conditionalSkip(
            !(approvalCall.success && cut.isApprovedForAll(alice, tokenOperator)),
    ...
    /// @custom:ercx-categories approval
    /// @custom:ercx-concerned-function setApprovalForAll
    function testCanApproveAnyAddressWhenOperator(uint256 tokenId, address operator, address tokenApprovee)
        external
        withUsers
        dealAnOwnedTokenToAlice(tokenId)
    {
